...
export const NotificationsPage = () => {
    ...
    const load = async () => {
      ...
      try {
        ...
        setNotifs(
          snap.docs.map((d) => ({
            id: d.id,
            title: d.data().title || 'System Notification',
            body: d.data().body,
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto pb-12">
      <div>
        <h1 className="text-3xl font-black uppercase text-white tracking-tight">Club Notifications</h1>
        <p className="text-sm text-slate-400">Real-time alerts for applications, trial acceptances, and verification updates.</p>
      </div>
